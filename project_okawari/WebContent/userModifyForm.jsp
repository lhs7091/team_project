				...
				<div class="col-md-8">
					<div class="card card-user">
						<div class="card-header">
							<h5 class="card-title">情報修正</h5>
						</div>
						<div class="card-body">
							<form action="userModify.okawari" method="post">
								<div class="row">
									...
									<div class="col-md-4 pr-1">
										<div class="form-group">
											<label>権限</label> <input type="text" class="form-control"
												name="user_auth" value="${dto.user_auth }"
												readonly="readonly">
										</div>
									</div>
								</div>
									...
									<div class="col-md-6 pr-1">
										<div class="form-group">
											<label>支店名</label> <input type="text" class="form-control"
												name="user_name" value="${dto.user_name }">
										</div>
									</div>
									<div class="col-md-6 pl-1">
										<div class="form-group">
											<label>支店長</label> <input type="text" class="form-control"
												name="user_manager" value="${dto.user_manager }">
										</div>
									</div>
								</div>
									...
									<div class="col-md-12">
										<div class="form-group">
											<label>アドレス</label> <input type="text" class="form-control"
												name="user_addr" value="${dto.user_addr }">
										</div>
									</div>
								</div>
									...
									<div class="col-md-3 pr-1">
										<div class="form-group">
											<label>電話番号</label> <input type="text" class="form-control"
												name="user_phone" value="${dto.user_phone }">
										</div>
									</div>
									<div class="col-md-3 px-1">
										<div class="form-group">
											<label>営業免許登録番号</label> <input type="text"
												...
												value="${dto.user_businum }">
										</div>
									</div>
									<div class="col-md-3 pl-1">
										<div class="form-group">
											<label>手数料</label> <input type="text" class="form-control"
												name="user_commission" value="${dto.user_commission }">
										</div>
									</div>
									<div class="col-md-3 pl-1">
										<div class="form-group">
											<label>オープン</label> <input type="text" class="form-control"
												name="user_commission" value="${dto.user_opendate }">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="update ml-auto mr-auto">
										<button type="submit" class="btn btn-primary btn-round">修正</button>
									</div>
								</div>
							</form>
						</div>
